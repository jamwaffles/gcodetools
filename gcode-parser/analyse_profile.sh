...
echo "Pprof..."
pprof --focus gcode_parser --nodecount=500 --nodefraction=0.0001 --edgefraction=0.0001 --maxdegree=128 --alloc_space --callgrind $BIN_PATH "./profiles/${BIN_NAME}.profile" > "./profiles/${BIN_NAME}.callgrind"
echo "Gprof2dot..."
